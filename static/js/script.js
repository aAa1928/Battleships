...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function updateUI() {
    switch (currentState) {
      ...
      case gameState.PLAYER_WON:
        targetGrid.style.pointerEvents = "none";
        showGameOverModal("Congratulations! You've won the game!");
        break;
      case gameState.COMPUTER_WON:
        targetGrid.style.pointerEvents = "none";
        showGameOverModal("Game Over! The computer has won.");
        break;
    }
  }
  ...
  function showGameOverModal(message) {
    ...
    if (!showGameOverModal.shown) {
      alert(message);
      showGameOverModal.shown = true;
    }
  }
